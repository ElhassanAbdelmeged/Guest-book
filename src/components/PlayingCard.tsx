  ...
  return (
    ...
    >
      ...
      <div className="flex h-full flex-col items-center justify-center px-2 py-5 text-center sm:px-3 sm:py-8">
        <div
          className={`mb-2 flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border-2 border-gold/60 bg-gradient-to-br from-cream to-cream-dark shadow-inner sm:h-28 sm:w-28 ${suitColor}`}
        >
          {center}
        </div>
