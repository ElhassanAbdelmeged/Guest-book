...
// Generated dynamically from DRIVE_URL via the QR Server API, so the code
// always points wherever DRIVE_URL points — no static image to swap out.
const qrSrc = `https://api.qrserver.com/v1/create-qr-code/?size=512x512&margin=8&data=${encodeURIComponent(
  DRIVE_URL
)}`;
