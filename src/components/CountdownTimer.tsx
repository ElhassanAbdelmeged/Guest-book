...
// Wedding: Thursday, August 13, 2026, 7:00 PM (Cairo / UTC+3 -> use +03:00 offset).
const TARGET = new Date("2026-08-13T19:00:00+03:00").getTime();
    ...
    <div className="flex items-stretch justify-center gap-2 sm:gap-4">
      {units.map((u, i) => (
        <div key={i} className="flex flex-col items-center">
          ...
          <span className="mt-2 text-[10px] font-semibold uppercase tracking-widest text-gold-dark sm:text-xs">
            {u.label}
          </span>
        </div>
      ))}
