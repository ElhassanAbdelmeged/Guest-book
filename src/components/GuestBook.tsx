...
export default function GuestBook() {
  ...
  return (
    <section
      id="guestbook"
      className="felt-bg relative px-4 py-20 sm:py-28"
    >
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-xl font-body text-sm text-ink/70 sm:text-base">
        ...
        <div className="mt-12 grid items-start gap-10 lg:grid-cols-2">
          ...
          >
            {loading ? (
              <div className="flex h-[460px] items-center justify-center font-body text-ink/60">
                {t("guestbook.loading")}
              </div>
            ) : pages.length === 0 ? (
              ...
              <div dir="ltr" className="flex w-full flex-col items-center">
                ...
                <div className="mt-6 flex items-center gap-4">
                  <button
                    onClick={flipPrev}
                    className="flex h-11 w-11 items-center justify-center rounded-full border border-gold/60 text-gold-dark transition hover:bg-gold hover:text-ink"
                  ...
                  <span className="min-w-[3.5rem] text-center font-body text-xs uppercase tracking-widest tabular-nums text-ink/50">
