# Mohamed & Nashwa Wedding Website
...
> Henna: Tuesday, August 11, 2026 · Wedding: Thursday, August 13, 2026 · 7:00 PM · Arabia Gardens — Ismailia

## Features

- Playing-cards themed design (King of Hearts = Mohamed, Queen of Hearts = Nashwa)
...
The QR image itself is generated on the fly (via the QR Server API) from `DRIVE_URL`, so it always
stays in sync — to change the destination, just edit `DRIVE_URL` in
[`src/components/PhotoUpload.tsx`](src/components/PhotoUpload.tsx).
...
Made with love for Mohamed & Nashwa.
